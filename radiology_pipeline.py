...
CONFIG = {
    "name": "Radiology for Surgeons",
    "input_file": "/Users/dr.moh/Documents/SIH/sih_project/MCQ Bank/extracted/raw_radiology.json",
    "output_file": "/Users/dr.moh/Documents/SIH/sih_project/js/questions/radiology.js",
    "checkpoint": "/Users/dr.moh/Documents/SIH/sih_project/MCQ Bank/extracted/radiology_checkpoint.json",
    "start_id": 150000,
...
def build_prompt(q):
    lines = [
        ...
        "This question heavily uses images, referenced via markdown `![Image](...)` tags.",
        ...
        "If there are image tags like `![Image](...)` in the question, YOU MUST INCLUDE THEM in the 'imaging_intraoperative_pearl' section if applicable, or keep them in the question string if asked.",
        "{",
        '  "status": "ACCEPT",',
        ...
        '  "imaging_intraoperative_pearl": "<What you would see on CT/X-ray/US/endoscopy OR in the OR for this topic. IF THE QUESTION HAS AN IMAGE, YOU MUST MENTION IT HERE>",',
...
async def process_config(client, config):
    ...
    async def process_task(qid, raw):
        ...
        if processed % SAVE_EVERY == 0:
            ...
            header = (
                f"// Auto-generated by radiology_pipeline.py\n"
