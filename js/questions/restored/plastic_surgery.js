...
window.QUESTIONS.push(...[
  {
    ...
    "sharp_metadata": {
      "S": "Review of Plastic Surgery clinical scenario.",
      "H": "Focus on the core pathophysiological principle behind the correct choice.",
      "A": "Consider why the other options are less likely given the specific patient presentation or surgical anatomy.",
      "R": "Standard surgical board principles and current practice guidelines.",
      "P": "Anchor your management plan to the verified guideline for this condition."
    }
  },
  {
    "specialty": "Plastic Surgery",
    ...
    "sharp_metadata": {
      "S": "Review of Plastic Surgery clinical scenario.",
      "H": "The prognosis for localized melanoma is best predicted by the Breslow thickness (measured in millimeters from the granular layer of the epidermis to the deepest part of the tumor).",
      "A": "Consider why the other options are less likely given the specific patient presentation or surgical anatomy.",
      "R": "AJCC Melanoma Staging",
      "P": "Breslow thickness is the most critical prognostic factor for localized melanoma."
    }
  },
  {
    "specialty": "Plastic Surgery",
